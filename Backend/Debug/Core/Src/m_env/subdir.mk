...
C_SRCS += \
../Core/Src/m_env/m_env.c \
../Core/Src/m_env/m_flash.c 

OBJS += \
./Core/Src/m_env/m_env.o \
./Core/Src/m_env/m_flash.o 

C_DEPS += \
./Core/Src/m_env/m_env.d \
./Core/Src/m_env/m_flash.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Src/m_env/%.o Core/Src/m_env/%.su Core/Src/m_env/%.cyclo: ../Core/Src/m_env/%.c Core/Src/m_env/subdir.mk
...
clean: clean-Core-2f-Src-2f-m_env

clean-Core-2f-Src-2f-m_env:
	-$(RM) ./Core/Src/m_env/m_env.cyclo ./Core/Src/m_env/m_env.d ./Core/Src/m_env/m_env.o ./Core/Src/m_env/m_env.su ./Core/Src/m_env/m_flash.cyclo ./Core/Src/m_env/m_flash.d ./Core/Src/m_env/m_flash.o ./Core/Src/m_env/m_flash.su

.PHONY: clean-Core-2f-Src-2f-m_env
